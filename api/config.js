...
const envSchema = z.object({
  ...
  FINANCE_RECONCILIATION_SIGNING_SECRET: z.string().min(16).default('transferly-finance-development-secret'),
  ...
  PAYOUT_AUTO_APPROVAL_MAX_CENTS: z.coerce.number().int().min(0).default(0),
  ...
  FUNDING_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(10),
  FUNDING_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(3600000),
  ...
  PROVIDER_INCIDENT_FAILED_WEBHOOK_THRESHOLD: z.coerce.number().int().positive().default(3),
  PROVIDER_INCIDENT_OPEN_ISSUE_THRESHOLD: z.coerce.number().int().positive().default(2),
  PAYMENT_PROVIDER_KILL_SWITCHES: z.string().default(''),
  PAYMENT_CORRIDOR_KILL_SWITCHES: z.string().default(''),
  ...
  PAYMENT_RECONCILIATION_INTERVAL_MS: z.coerce.number().int().min(60000).max(2592000000).default(900000),
  PAYMENT_RECONCILIATION_INVOICE_LIMIT: z.coerce.number().int().min(1).max(500).default(25),
  PAYMENT_RECONCILIATION_PAYOUT_LIMIT: z.coerce.number().int().min(1).max(500).default(25),
